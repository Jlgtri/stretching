...
class SMStudioModel implements Comparable<SMStudioModel> {
  ...
  Map<String, Object?> toMap() => <String, Object?>{
        ...
        'media_gallery_site': mediaGallerySite
            .map((final x) => x.toMap())
  ...
  @override
  String toString() => 'SMStudioModel(id: $id, cctStatus: $cctStatus, '
...
class SMStudioMediaModel {
  ...
  Map<String, Object?> toMap() =>
      <String, Object?>{'id': id.toString(), if (url != null) 'url': url};
  ...
  factory SMStudioMediaModel.fromJson(final String source) =>
      SMStudioMediaModel.fromMap(json.decode(source) as Map<String, Object?>);

  /// Return the copy of this model.
  SMStudioMediaModel copyWith({final int? id, final String? url}) =>
      SMStudioMediaModel(id: id ?? this.id, url: url ?? this.url);
...
class SMStudioTagsModel {
  ...
  @override
  String toString() => 'SMStudioTagsModel(trx: $trx, stretching: $stretching, '
