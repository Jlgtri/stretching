...
class SMActivityPriceModel {
  ...
  @override
  String toString() => 'SMActivityPriceModel(regularPrice: $regularPrice, '
...
class SMActivityPriceOptionValueModel {
  ...
  SMActivityPriceOptionValueModel copyWith({final num? optionValue}) =>
      SMActivityPriceOptionValueModel(optionValue ?? this.optionValue);

  /// Convert this model to map with string keys.
  Map<String, Object?> toMap() =>
      <String, Object?>{'option_value': optionValue};

  /// Convert the map with string keys to this model.
  factory SMActivityPriceOptionValueModel.fromMap(
    final Map<String, Object?> map,
  ) =>
      SMActivityPriceOptionValueModel(
  ...
  factory SMActivityPriceOptionValueModel.fromJson(final String source) =>
      SMActivityPriceOptionValueModel.fromMap(
  ...
  @override
  String toString() =>
      'SMActivityPriceOptionValueModel(optionValue: $optionValue)';
}
