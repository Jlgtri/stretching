...
class SMStoryModel {
  ...
  factory SMStoryModel.fromMap(final Map<String, Object?> map) => SMStoryModel(
  ...
  @override
  String toString() =>
      'SMStoryModel(id: $id, cctStatus: $cctStatus, media: $media, '
...
class SMStoryContentModel {
  ...
  SMStoryContentModel copyWith({final int? id, final String? url}) =>
      SMStoryContentModel(id: id ?? this.id, url: url ?? this.url);
