...
class RecordModel {
  ...
  factory RecordModel.fromMap(final Map<String, Object?> map) => RecordModel(
        id: map['id']! as int,
        ...
        masterRequest:
            boolToIntConverter.fromJson(map['master_request']! as int),
  ...
  @override
  String toString() =>
      'RecordModel(id: $id, companyId: $companyId, staffId: $staffId, '
...
class RecordLabelModel {
  ...
  @override
  String toString() =>
      'RecordLabelModel(id: $id, title: $title, color: $color, '
...
class RecordClientModel {
  ...
  @override
  String toString() => 'RecordClientModel(id: $id, name: $name, phone: $phone, '
...
class RecordDocumentModel {
  ...
  @override
  String toString() => 'RecordDocumentModel(id: $id, typeId: $typeId, '
...
class RecordServiceModel {
  ...
  @override
  String toString() =>
      'RecordServiceModel(id: $id, title: $title, cost: $cost, '
...
class RecordStaffModel {
  ...
  @override
  String toString() => 'RecordStaffModel(id: $id, apiId: $apiId, name: $name, '
...
class RecordStaffPositionModel {
  ...
  factory RecordStaffPositionModel.fromJson(final String source) =>
      RecordStaffPositionModel.fromMap(
  ...
  @override
  String toString() => 'RecordStaffPositionModel(id: $id, title: $title)';
}
