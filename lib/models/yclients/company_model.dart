...
class CompanyModel implements Comparable<CompanyModel> {
  ...
  factory CompanyModel.fromMap(final Map<String, Object?> map) => CompanyModel(
        ...
        nextSlot:
            optionalDateTimeConverter.fromJson(map['next_slot'] as String?),
        ...
        photos: (map['photos']! as Iterable<Object?>).cast<String>().map(
              (final url) =>
                  Uri.parse(url).host.isEmpty ? '$yClientsAssetsUrl/$url' : url,
            ),
  ...
  bool operator ==(final Object other) =>
      ...
      other is CompanyModel &&
          ...
          other.pushNotificationPhoneConfirm == pushNotificationPhoneConfirm &&
  ...
  @override
  String toString() =>
      'CompanyModel(id: $id, title: $title, publicTitle: $publicTitle, '
...
class CompanyMainGroupModel {
  ...
  CompanyMainGroupModel copyWith({final int? id, final String? title}) =>
      CompanyMainGroupModel(id: id ?? this.id, title: title ?? this.title);
  ...
  bool operator ==(final Object other) =>
      identical(this, other) ||
      other is CompanyMainGroupModel && other.id == id && other.title == title;
...
class CompanySocialModel {
  ...
  @override
  String toString() => 'CompanySocialModel(facebook: $facebook, vk: $vk, '
