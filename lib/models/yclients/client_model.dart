...
class ClientModel {
  ...
  factory ClientModel.fromMap(final Map<String, Object?> map) => ClientModel(
        id: map['id']! as int,
  ...
  @override
  String toString() =>
      'ClientModel(id: $id, name: $name, phone: $phone, email: $email, '
...
class FullClientModel {
  ...
  @override
  String toString() => 'FullClientModel(id: $id, name: $name, phone: $phone, '
