...
/// The converter of the [UserRecordModel].
const RecordConverter recordConverter = RecordConverter._();

/// The converter of the [UserRecordModel].
class RecordConverter
    implements JsonConverter<UserRecordModel, Map<String, Object?>> {
  const RecordConverter._();

  @override
  UserRecordModel fromJson(final Map<String, Object?> data) =>
      UserRecordModel.fromMap(data);

  @override
  Map<String, Object?> toJson(final UserRecordModel data) => data.toMap();
}
...
class UserRecordModel implements Comparable<UserRecordModel> {
  ...
  @override
  String toString() =>
      'UserRecordModel(id: $id, services: $services, company: $company, '
...
/// The company model for the [UserRecordModel].
@immutable
class RecordCompanyModel {
  ...
  factory RecordCompanyModel.fromMap(final Map<String, Object?> map) =>
      RecordCompanyModel(
        ...
        allowChangeRecordDelayStep:
            map['allow_change_record_delay_step']! as int,
        allowDeleteRecordDelayStep:
            map['allow_delete_record_delay_step']! as int,
      );
  ...
  @override
  String toString() => 'RecordCompanyModel(id: $id, title: $title, '
...
class RecordStaffModel {
  ...
  @override
  String toString() => 'RecordStaffModel(id: $id, name: $name, '
