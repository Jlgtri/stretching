...
class ActivityModel implements Comparable<ActivityModel> {
  ...
  factory ActivityModel.fromMap(final Map<String, Object?> map) =>
      ActivityModel(
        ...
        service: ActivityServiceModel.fromMap(
          map['service']! as Map<String, Object?>,
        ),
        staff:
            ActivityStaffModel.fromMap(map['staff']! as Map<String, Object?>),
  ...
  @override
  String toString() => 'ActivityModel(id: $id, serviceId: $serviceId, '
...
class ActivityResourceInstanceModel {
  ...
  @override
  String toString() => 'ActivityResourceInstanceModel(id: $id, title: $title, '
...
class ActivityServiceModel {
  ...
  @override
  String toString() => 'ActivityServiceModel(id: $id, categoryId: $categoryId, '
...
class ActivityServiceCategoryModel {
  ...
  Map<String, Object?> toMap() =>
      <String, Object?>{'id': id, 'category_id': categoryId, 'title': title};
  ...
  @override
  String toString() =>
      'ActivityServiceCategoryModel(id: $id, categoryId: $categoryId, '
      'title: $title)';
}
...
class ActivityStaffModel {
  ...
  @override
  String toString() =>
      'ActivityStaffModel(id: $id, apiId: $apiId, name: $name, '
