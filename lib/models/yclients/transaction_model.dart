...
class TransactionModel {
  ...
  factory TransactionModel.fromMap(final Map<String, Object?> map) =>
      TransactionModel(
        state: TransactionStateModel.fromMap(
  ...
  @override
  String toString() => 'TransactionModel(state: $state, kkmState: $kkmState, '
...
class TransactionKKMStateModel {
  ...
  factory TransactionKKMStateModel.fromJson(final String source) =>
      TransactionKKMStateModel.fromMap(
  ...
  @override
  String toString() =>
      'TransactionKKMStateModel(showPayerInfo: $showPayerInfo, '
...
class TransactionPaymentMethodModel {
  ...
  factory TransactionPaymentMethodModel.fromJson(final String source) =>
      TransactionPaymentMethodModel.fromMap(
        json.decode(source) as Map<String, Object?>,
      );
  ...
  @override
  String toString() => 'TransactionPaymentMethodModel(slug: $slug, '
...
class TransactionPaymentMethodAccountModel {
  ...
  TransactionPaymentMethodAccountModel copyWith({
    ...
    final bool? isDefault,
      ...
      TransactionPaymentMethodAccountModel(
        id: id ?? this.id,
  ...
  @override
  int get hashCode =>
      id.hashCode ^ title.hashCode ^ isCash.hashCode ^ isDefault.hashCode;

  @override
  String toString() =>
      'TransactionPaymentMethodAccountModel(id: $id, title: $title, '
...
class TransactionPaymentMethodLoyaltyProgramModel {
  ...
  TransactionPaymentMethodLoyaltyProgramModel copyWith({
    ...
    final TransactionPaymentMethodLoyaltyProgramExpenseModel? chain,
      ...
      TransactionPaymentMethodLoyaltyProgramModel(
        id: id ?? this.id,
        title: title ?? this.title,
  ...
  @override
  String toString() => 'TransactionPaymentMethodLoyaltyProgramModel(id: $id, '
...
class TransactionPaymentMethodLoyaltyProgramExpenseModel {
  ...
  TransactionPaymentMethodLoyaltyProgramExpenseModel copyWith({
    ...
    final String? title,
      ...
      TransactionPaymentMethodLoyaltyProgramExpenseModel(
        id: id ?? this.id,
        title: title ?? this.title,
      );
  ...
  factory TransactionPaymentMethodLoyaltyProgramExpenseModel.fromJson(
    final String source,
      ...
      TransactionPaymentMethodLoyaltyProgramExpenseModel.fromMap(
        json.decode(source) as Map<String, Object?>,
      );
  ...
  @override
  String toString() =>
      'TransactionPaymentMethodLoyaltyProgramExpenseModel(id: $id, '
      'title: $title)';
}
...
class TransactionStateModel {
  ...
  Map<String, Object?> toMap() => <String, Object?>{
        'items':
            items.map((final item) => item.toMap()).toList(growable: false),
  ...
  factory TransactionStateModel.fromMap(final Map<String, Object?> map) =>
      TransactionStateModel(
        ...
        paymentTransactions: (map['payment_transactions']! as Iterable)
            .cast<Map<String, Object?>>()
            .map(TransactionStatePaymentTransactionModel.fromMap),
      );
  ...
  @override
  String toString() => 'TransactionStateModel(items: $items, '
...
class TransactionStateItemModel {
  ...
  factory TransactionStateItemModel.fromJson(final String source) =>
      TransactionStateItemModel.fromMap(
        json.decode(source) as Map<String, Object?>,
      );
  ...
  @override
  String toString() =>
      'TransactionStateItemModel(id: $id, type: $type, title: $title, '
...
class TransactionStatePaymentTransactionModel {
  ...
  TransactionStatePaymentTransactionModel copyWith({
    ...
    final TransactionPaymentMethodLoyaltyProgramExpenseModel? expense,
      ...
      TransactionStatePaymentTransactionModel(
        id: id ?? this.id,
  ...
  factory TransactionStatePaymentTransactionModel.fromJson(
    final String source,
      ...
      TransactionStatePaymentTransactionModel.fromMap(
        json.decode(source) as Map<String, Object?>,
      );
  ...
  @override
  String toString() => 'TransactionStatePaymentTransactionModel(id: $id, '
