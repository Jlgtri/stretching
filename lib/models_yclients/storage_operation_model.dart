...
class StorageOperationModel {
  ...
  @override
  String toString() {
    return 'StorageOperationModel(userId: $userId, companyId: $companyId, '
...
class StorageOperationDocumentModel {
  ...
  StorageOperationDocumentModel copyWith({
    ...
    return StorageOperationDocumentModel(
      id: id ?? this.id,
      typeId: typeId ?? this.typeId,
      type: type ?? this.type,
      storageId: storageId ?? this.storageId,
  ...
  factory StorageOperationDocumentModel.fromJson(final String source) {
    return StorageOperationDocumentModel.fromMap(
      json.decode(source) as Map<String, Object?>,
    );
  }
  ...
  @override
  String toString() {
    return 'StorageOperationDocumentModel(id: $id, typeId: $typeId, '
...
class StorageOperationDocumentCompanyModel {
  ...
  StorageOperationDocumentCompanyModel copyWith({
    ...
    return StorageOperationDocumentCompanyModel(
      id: id ?? this.id,
  ...
  factory StorageOperationDocumentCompanyModel.fromJson(final String source) {
    return StorageOperationDocumentCompanyModel.fromMap(
      json.decode(source) as Map<String, Object?>,
    );
  }
  ...
  @override
  String toString() {
    return 'StorageOperationDocumentCompanyModel(id: $id, title: $title, '
...
class StorageOperationDocumentStorageModel {
  ...
  StorageOperationDocumentStorageModel copyWith({
    ...
    return StorageOperationDocumentStorageModel(
      id: id ?? this.id,
      title: title ?? this.title,
    );
  }
  ...
  factory StorageOperationDocumentStorageModel.fromJson(final String source) {
    return StorageOperationDocumentStorageModel.fromMap(
      json.decode(source) as Map<String, Object?>,
    );
  }
  ...
  @override
  String toString() {
    return 'StorageOperationDocumentStorageModel(id: $id, title: $title)';
  }
}
...
class StorageOperationDocumentTypeModel {
  ...
  StorageOperationDocumentTypeModel copyWith({
    ...
    return StorageOperationDocumentTypeModel(
      id: id ?? this.id,
      title: title ?? this.title,
    );
  }
  ...
  factory StorageOperationDocumentTypeModel.fromJson(final String source) {
    return StorageOperationDocumentTypeModel.fromMap(
      json.decode(source) as Map<String, Object?>,
    );
  }
  ...
  @override
  String toString() {
    return 'StorageOperationDocumentTypeModel(id: $id, title: $title)';
  }
}
...
class StorageOperationDocumentUserModel {
  ...
  StorageOperationDocumentUserModel copyWith({
    ...
    return StorageOperationDocumentUserModel(
      id: id ?? this.id,
      name: name ?? this.name,
      phone: phone ?? this.phone,
    );
  ...
  /// Convert this model to map with string keys.
  Map<String, Object?> toMap() {
    return <String, Object?>{'id': id, 'name': name, 'phone': phone};
  }
  ...
  factory StorageOperationDocumentUserModel.fromJson(final String source) {
    return StorageOperationDocumentUserModel.fromMap(
      json.decode(source) as Map<String, Object?>,
    );
  }
  ...
  @override
  String toString() {
    return 'StorageOperationDocumentUserModel(id: $id, name: $name, '
        'phone: $phone)';
  }
}
