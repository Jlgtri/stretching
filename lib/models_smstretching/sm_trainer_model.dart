...
class SMTrainerModel {
  ...
  @override
  String toString() {
    return 'SMTrainerModel(id: $id, cctStatus: $cctStatus, '
...
class SMTrainerClassesModel {
  ...
  factory SMTrainerClassesModel.fromMap(final Map<String, Object?> map) {
    return SMTrainerClassesModel(
      ...
      hotPilates: boolToStringConverter.fromJson(map['Hot Pilates']! as String),
  ...
  @override
  String toString() {
    return 'SMTrainerClassesModel(trx: $trx, stretching: $stretching, '
