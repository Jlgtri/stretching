            ...
            TextFormField(
              ...
              decoration: InputDecoration(
                ...
                suffixIconConstraints:
                    const BoxConstraints(maxWidth: 30, maxHeight: 24),
              ),
            ),
            if (!hasFocus.value &&
              ...
              Padding(
                padding: EdgeInsets.only(
                  right: 20,
                  top: 14 /
                      (mediaQuery.textScaleFactor * mediaQuery.textScaleFactor),
                ),
                child: FontIcon(
                  FontIconData(
                    IconsCG.confirmed,
                    fit: BoxFit.cover,
                    height: 18 * mediaQuery.textScaleFactor,
                    padding: const EdgeInsets.only(bottom: 4),
                    alignment: Alignment.center,
                    color: theme.colorScheme.onSurface.withOpacity(4 / 5),
                  ),
                ),
              )
            else if (hasFocus.value && text.value.isNotEmpty)
              Padding(
                padding: EdgeInsets.only(
                  right: 14,
                  top: 10 /
                ...
                child: FontIconButton(
                  FontIcon(
                    FontIconData(
                      IconsCG.close,
                      fit: BoxFit.cover,
                      height: 14 * mediaQuery.textScaleFactor,
                      padding: const EdgeInsets.only(bottom: 4),
                      alignment: Alignment.center,
                      color: theme.colorScheme.onSurface.withOpacity(4 / 5),
                    ),
